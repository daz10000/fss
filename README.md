...
[Enter useful description for fss]
...
macOS/Linux | Windows
--- | ---
[![Travis Badge](https://travis-ci.org/MyGithubUsername/fss.svg?branch=master)](https://travis-ci.org/MyGithubUsername/fss) | [![Build status](https://ci.appveyor.com/api/projects/status/github/MyGithubUsername/fss?svg=true)](https://ci.appveyor.com/project/MyGithubUsername/fss)
[![Build History](https://buildstats.info/travisci/chart/MyGithubUsername/fss)](https://travis-ci.org/MyGithubUsername/fss/builds) | [![Build History](https://buildstats.info/appveyor/chart/MyGithubUsername/fss)](https://ci.appveyor.com/project/MyGithubUsername/fss)  

## NuGet 

Package | Stable | Prerelease
--- | --- | ---
fss | [![NuGet Badge](https://buildstats.info/nuget/fss)](https://www.nuget.org/packages/fss/) | [![NuGet Badge](https://buildstats.info/nuget/fss?includePreReleases=true)](https://www.nuget.org/packages/fss/)
